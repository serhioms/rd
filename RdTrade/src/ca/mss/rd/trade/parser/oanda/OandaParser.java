...
public class OandaParser <Row extends ParserRow> extends AbstractParser<Row> {
	...
	public static void main(String[] args) {
		new OandaParser<OandaParserNewRow>("/Users/smoskovskiy/workspace/rd/RdTraderConsole/data/Oanda-Online/2014/05-May/20/20140513-165815-937=Oanda-Online=1-sec.txt")
			//.generateCode();
			.test();
	}
