...
public class MarkitLiquidityMetrics <Row extends ParserRow> extends AbstractParser<Row> {
	...
	public static void main(String[] args) {
		new MarkitLiquidityMetrics<MarkitLiquidityMetricsRow>("/Users/smoskovskiy/workspace/rd/RdTraderConsole/data/Oanda-Online/2014/07-Jul/27/20140702=Oanda-Online=3-sec.txt")
			//.generateCode();
			.test();
	}
