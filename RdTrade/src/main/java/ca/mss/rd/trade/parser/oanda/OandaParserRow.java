...
public class OandaParserRow extends DefaultRow implements ParserRow {

	final static public String module = OandaParserRow.class.getName();
...
/*			map(DATA_RECORD_MAPPER, "Same", index++),
	...
	public class Record implements GenericRecord, Getter {
