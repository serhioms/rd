...
public class RdChecksumGeneration extends RdExecDefault {
	...
	public String toString() {
		...
		String src = String.format("[pattern=%s,uri=%s,out=%s]", sourceResource.getSearchPattern(), sourceResource.getUri(), sourceResource.getMatchUriOutPro());
		String mrk = String.format("[pattern=%s,uri=%s,out=%s]", markerResource.getSearchPattern(), markerResource.getUri(), markerResource.getMatchUriOutPro());
