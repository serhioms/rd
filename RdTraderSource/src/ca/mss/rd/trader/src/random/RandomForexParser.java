 ...
 * 
 */
public class RandomForexParser <Row extends ParserRow> extends AbstractParser<Row> {

	final static public String module = RandomForexParser.class.getName();
	...
	public RandomForexParser(String path) {
		super(path);
	}
