...
public class TestMarkitComposites {

	final static public String module = TestMarkitComposites.class.getName();
	...
	final static public String REPORT_COMPOSITES = "COMPOSITES";
	...
	final static public String DATA = "201305014";
	final static public String FILE_PATH = "results/http/markit_site="+VERSION+"="+REPORT+"="+DATA+"."+FORMAT;
