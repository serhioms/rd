 ...
 * 
 */
public class Combinations<Type> implements Enumeration<ArrayList<Type>>
{
    private Type[] inArray;
    private int n, m;
    private int[] index;
    ...
    */
    public Combinations(Type[] inArray, int m) throws CombinatoricException
    {
    ...
    */
    public ArrayList<Type> nextElement()
    {
        if (!hasMore)
            return null;

        ArrayList<Type> out = new ArrayList<Type>(m);
        for (int i = 0; i < m; i++)
            out.add(i, inArray[index[i]]);
