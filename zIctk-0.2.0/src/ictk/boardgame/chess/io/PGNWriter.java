...
public synchronized void writeHistory (History history) 
   ...
   protected void walkMoveTreeBreadthFirst (ContinuationList cont, 
	 ...
	 if (cont != null && !cont.isTerminal()) {
	    ...
	    if (cont.getMove(0) != null)
	       isBlackMove = ((ChessMove)cont.getMove(0)).isBlackMove();
	    else if (cont.getMove(1) != null)
	       isBlackMove = ((ChessMove)cont.getMove(1)).isBlackMove();
	    else
	       assert false
