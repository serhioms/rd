 ...
 *  All rights reserved.
 *
 *  $Id: ChessMove.java,v 1.8 2003/08/20 14:29:06 jvarsoke Exp $
 *
...
import static ictk.boardgame.chess.ChessPiece.toChessPiece;
 ...
 *</pre>
 */
public class ChessMove extends Move implements Sortable<Long> {
	
	/* mss2014 evaluation score */
	@Override
	public Long sortby() {
		return score;
	}
   ...
   public ChessMove (ChessBoard b, int of, int or, 
      ...
      if (promo > 0) 
    	  promotion = ChessPiece.toChessPiece(promo);
   ...
   protected void execute ()  
	 ...
	 // mss: moved up due to https://sourceforge.net/tracker/?func=detail&aid=1198015&group_id=67303&atid=517494
    ...
    if (casualty != null) { 
	    ...
	    casualty.moveDetector--; // mss[2009.10.28]: change move detector for capture pieces as well
	 }
...
*/
	 ...
	 if (piece.isPawn() && Pawn.isPromotionSquare(dest, piece.isBlack)) {
	    if (promotion == null)  //auto promo
	       promotion  = new Queen();
	    else if( promotion == casualty ) // mss 2011: promotion with causality bug fixing
    ...
    */
   public String toString (boolean withScore) {
   ...
   public String toStringNV() {
	   return orig.toString() + "-" + dest.toString();
   }
