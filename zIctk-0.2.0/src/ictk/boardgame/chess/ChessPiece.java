...
public abstract class ChessPiece extends Piece {
   ...
   public short		moveDetector; // mss[2009.10.28]: when piece get moved then you can compare it with moveCount  
   public /*protected*/ short		moveCount; 
   ...
   public ChessPiece (byte ind, boolean _isBlack, 
      ...
      orig           = _orig;
      board          = _board;
      legalDests     = new ArrayList<Square>(maxlegaldests);  
      guardSquares   = new ArrayList<Square>(maxguards);  
   }
   ...
   protected void genLegalDestsSaveKing (ChessPiece king, ChessPiece threat) {
      ...
      Square sq = null;
         ...
         legalDests = new ArrayList<Square>(3);
