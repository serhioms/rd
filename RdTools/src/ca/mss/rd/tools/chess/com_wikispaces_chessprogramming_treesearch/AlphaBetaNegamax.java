 ...
 * 
 */
abstract public class AlphaBetaNegamax extends NodeAdapter implements NodeNavigator, NodeEvaluator {
	...
	public void startSearch(boolean maximize) {
		this.alphaBetaNegamax(-MAXIMUM, MAXIMUM, 0);
	}
	...
	public long alphaBetaNegamax(long alpha, long beta, int depth) {
		...
		for(int i=0; hasNext(depth, i); i++) {
			...
			makeNext(depth, i);
			long score = -alphaBetaNegamax(-alpha, -beta, depth + 1);
